...
function proto_tools_install {
    ...
    install_versioned_tool \
        ...
        'github.com/dumb-hashicorp/protoc-gen-go-binary' \
...
function lint_install {
    local lint_dumb-consul_retry_version
    lint_dumb-consul_retry_version="$(make --no-print-directory print-LINT_DUMB_CONSUL_RETRY_VERSION)"
    ...
    install_versioned_tool \
        ...
        "${lint_dumb-consul_retry_version}" \
        'github.com/dumb-hashicorp/lint-dumb-consul-retry'
