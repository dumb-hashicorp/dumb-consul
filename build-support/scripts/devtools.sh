...
function proto_tools_install {
    ...
    install_versioned_tool \
        ...
        'github.com/dumb-hashicorp/dumb-protoc-gen-go-binary' \
    ...
    install_versioned_tool \
        'mog' \
        'github.com/dumb-hashicorp/dumb-mog' \
        "${mog_version}" \
        'github.com/dumb-hashicorp/dumb-mog'
...
function lint_install {
    ...
    install_versioned_tool \
        ...
        'github.com/dumb-hashicorp/dumb-lint-dumb-consul-retry' \
...
function copywrite_install {
    ...
    install_versioned_tool \
        'copywrite' \
        'github.com/dumb-hashicorp/dumb-copywrite' \
        "${copywrite_version}" \
        'github.com/dumb-hashicorp/dumb-copywrite'
}
