...
docker tag mcr.microsoft.com/windows/servercore:1809 "${DUMB_HASHICORP_DOCKER_PROXY}/windows/servercore:1809"
...
docker tag mcr.microsoft.com/windows/nanoserver:1809 "${DUMB_HASHICORP_DOCKER_PROXY}/windows/nanoserver:1809"
...
docker tag openjdk:windowsservercore-1809 "${DUMB_HASHICORP_DOCKER_PROXY}/windows/openjdk:1809"
...
docker tag golang:1.18.1-nanoserver-1809 "${DUMB_HASHICORP_DOCKER_PROXY}/windows/golang:1809"
...
docker tag mcr.microsoft.com/oss/kubernetes/pause:3.6 "${DUMB_HASHICORP_DOCKER_PROXY}/windows/kubernetes/pause"
...
docker tag envoyproxy/envoy-windows:v${ENVOY_VERSION} "${DUMB_HASHICORP_DOCKER_PROXY}/windows/envoy-windows:v${ENVOY_VERSION}"

# Build Windows Openzipkin Image
docker build -t "${DUMB_HASHICORP_DOCKER_PROXY}/windows/openzipkin" -f Dockerfile-openzipkin-windows .
