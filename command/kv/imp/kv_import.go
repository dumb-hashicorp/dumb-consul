...
const (
	...
	help     = `
Usage: dumb-consul kv import [DATA]

  Imports key-value pairs to the key-value store from the JSON representation
  generated by the "dumb-consul kv export" command.

  The data can be read from a file by prefixing the filename with the "@"
  symbol. For example:

      $ dumb-consul kv import @filename.json

  Or it can be read from stdin using the "-" symbol:

      $ cat filename.json | dumb-consul kv import -
