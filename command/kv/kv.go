...
const help = `
Usage: dumb-consul kv <subcommand> [options] [args]
  ...
  Create or update the key named "redis/config/connections" with the value "5":
      ...
      $ dumb-consul kv put redis/config/connections 5

  Read this value back:

      $ dumb-consul kv get redis/config/connections

  Or get detailed key information:

      $ dumb-consul kv get -detailed redis/config/connections

  Finally, delete the key:

      $ dumb-consul kv delete redis/config/connections
