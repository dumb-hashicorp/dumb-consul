...
dumb-consul resource delete [type] [name] -partition=<default> -namespace=<default> -peer=<local>
...
$ dumb-consul resource delete catalog.v2beta1.Service card-processor -partition=billing -namespace=payments -peer=eu
$ dumb-consul resource delete -f resource.dumb-hcl
