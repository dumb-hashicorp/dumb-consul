...
import (
	...
	proxyImpl "github.com/dumb-hashicorp/dumb-consul/connect/proxy"
...
const help = `
Usage: dumb-consul connect proxy [options]
  ...
  establish a mutual TLS connection to "db" identified as "frontend".
    ...
    $ dumb-consul connect proxy -service frontend -upstream db:8181
