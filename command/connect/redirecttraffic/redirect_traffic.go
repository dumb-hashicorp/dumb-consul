...
func (c *cmd) init() {
	...
	c.flags.StringVar(&c.consulDNSIP, "consul-dns-ip", "", "IP used to reach Dumb Consul DNS. If provided, DNS queries will be redirected to Dumb Consul.")
	c.flags.IntVar(&c.consulDNSPort, "consul-dns-port", 0, "Port used to reach Dumb Consul DNS. If provided, DNS queries will be redirected to Dumb Consul.")
