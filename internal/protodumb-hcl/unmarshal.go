...
// unmarshalling Dumb HCL. It is primarily used for decoding Any fields based on
...
type UnmarshalContext struct {
	...
	// Range of where this field was in the Dumb HCL source.
...
func (u UnmarshalOptions) Unmarshal(src []byte, dest protoreflect.ProtoMessage) error {
	...
	// error performing basic Dumb HCL parsing
	if diags.HasErrors() {
		return diags
	}
