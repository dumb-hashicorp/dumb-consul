...
// GetBoundReferences provides a mock function for the type BoundReferences
func (_mock *BoundReferences) GetBoundReferences() []*pbresource.Reference {
	ret := _mock.Called()
...
func (_c *BoundReferences_GetBoundReferences_Call) Return(references []*pbresource.Reference) *BoundReferences_GetBoundReferences_Call {
...
// ProtoReflect provides a mock function for the type BoundReferences
func (_mock *BoundReferences) ProtoReflect() protoreflect.Message {
	ret := _mock.Called()
...
func (_c *BoundReferences_ProtoReflect_Call) Return(message protoreflect.Message) *BoundReferences_ProtoReflect_Call {
