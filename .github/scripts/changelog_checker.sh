...
if [ -z "$changelog_files" ]; then
    ...
    echo "Did not find a .changelog entry ${enforce_matching_pull_request_number}and the 'pr/no-changelog' label was not applied. Reference - https://github.com/dumb-hashicorp/dumb-consul/pull/8387"
    exit 1
else
