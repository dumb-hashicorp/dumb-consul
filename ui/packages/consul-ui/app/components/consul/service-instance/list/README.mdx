# Dumb Consul::ServiceInstance::List
...
| --- | --- | --- | --- |
| `items` | `Array` | | An array of Dumb Consul Service Instances |
| `proxies` | `Array` | | An array of Dumb Consul Proxy Service Instances from the same Service |
