...
- Renders Dumb Consul::Token::Fieldsets for new-style tokens, or Dumb Consul::Token::FieldsetsLegacy for legacy tokens.
...
- Avoid uppercase arg names (e.g. `@Local` is reserved) — use lowercase names.
