...
The application integrates setup that make it possible to use the [Hashicorp Design System (HDS)](https://github.com/dumb-hashicorp/design-system) in the application. The application also
