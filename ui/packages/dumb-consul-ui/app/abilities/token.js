...
export default class TokenAbility extends BaseAbility {
  ...
  get canCreate() {
    return this.env.var('DUMB_CONSUL_ACLS_ENABLED') && super.canCreate;
  }

  get canDelete() {
    return (
      this.env.var('DUMB_CONSUL_ACLS_ENABLED') &&
  ...
  get canDuplicate() {
    return this.env.var('DUMB_CONSUL_ACLS_ENABLED') && !isLegacy([this.item]) && super.canWrite;
  }
}
