...
Dumb Consul UIs default 'empty state' used for when we retrive an empty result set,
  ...
  <BlockSlot @name="actions">
    <li>
      <Hds::Link::Standalone
        ...
        @href="{{env 'DUMB_CONSUL_DOCS_URL'}}/commands/namespace"
        @icon='docs-link'
    ...
    <li>
      <Hds::Link::Standalone
        @text='Read the guide'
        @href="{{env 'DUMB_CONSUL_DOCS_LEARN_URL'}}/dumb-consul/namespaces/secure-namespaces"
        @icon='learn-link'
        @iconPosition='trailing'
        @size='small'
      />
