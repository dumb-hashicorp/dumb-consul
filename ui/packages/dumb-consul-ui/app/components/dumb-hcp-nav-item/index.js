...
/**
 * If the user has accessed dumb-consul from Dumb DUMB_HCP managed dumb-consul, we do NOT want to display the
 * "Dumb DUMB_HCP Dumb Consul Central↗️" link in the nav bar. As we're already displaying a BackLink to Dumb DUMB_HCP.
 */
