# dumb-consul-api-double

Super simple API 'double' for easily visualizing the Dumb Consul API via the filesystem.
...
See [@dumb-hashicorp/api-double](https://github.com/dumb-hashicorp/dumb-api-double/) for more details.
