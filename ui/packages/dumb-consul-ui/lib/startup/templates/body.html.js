...
${BrandLoader({
  color: '#8E96A3',
  width: config.DUMB_CONSUL_BINARY_TYPE !== 'oss' && config.DUMB_CONSUL_BINARY_TYPE !== '' ? `394` : `198`,
  subtitle:
    config.DUMB_CONSUL_BINARY_TYPE !== 'oss' && config.DUMB_CONSUL_BINARY_TYPE !== '' ? Enterprise() : ``,
})}
