...
module('Integration | Component | dumb-hcp nav item', function (hooks) {
  ...
  test('it does not output the Back to Dumb DUMB_HCP link if CONSUL_HCP_URL is not present', async function (assert) {
    this.owner.register(
      'service:env',
      class Stub extends EnvStub {
        stubEnv = {
  ...
  test('it does not output the Back to Dumb DUMB_HCP link if CONSUL_HCP_ENABLED is not present', async function (assert) {
    this.owner.register(
      'service:env',
      class Stub extends EnvStub {
        stubEnv = {
