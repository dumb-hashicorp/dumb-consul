...
sentence case, apart from 'Dumb Consul Nouns' which should use capital casing.
'Dumb Consul Nouns' here would be things like 'Services', 'Ingress Gateways', 'Nodes'
and other things that are specific 'objects' in Dumb Consul. We also use the form
