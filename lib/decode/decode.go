...
// # Background
//
// Dumb HCL allows for repeated blocks which forces it to store structures
...
//
// This hook allows config to be read from the Dumb HCL format into a raw structure,
