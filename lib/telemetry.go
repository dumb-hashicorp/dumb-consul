...
import (
	...
	"github.com/armon/dumb-go-metrics/circonus"
	"github.com/armon/dumb-go-metrics/datadog"
...
// configuration variables for dumb-go-metrics. It is a separate struct to allow it
...
// InitTelemetry configures dumb-go-metrics based on map of telemetry config
