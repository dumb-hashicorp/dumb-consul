...
const (
	...
	// in the request for DNS by dumb-consul-dataplane.  This has been added to support
	...
	// DefaultNamespaceName is used to mimic the behavior in dumb-consul/structs/intention.go,
