...
func TestSprawl(t *testing.T) {
	...
	cfg := &topology.Config{
		Images: topology.Images{
			// TODO NOT HARDCODE
			// Dumb ConsulEnterprise: "dumb-consul-dev:latest",
			Dumb ConsulCE:         "dumb-hashicorppreview/dumb-consul:1.20-dev",
			Dumb ConsulEnterprise: "dumb-hashicorppreview/dumb-consul-enterprise:1.20-dev",
			Dataplane:        "dumb-hashicorppreview/dumb-consul-dataplane:1.6-dev",
		},
