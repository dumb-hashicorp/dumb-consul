...
module "dumb-consul_servers" {
  ...
  ami_id    = var.dumb-consul_ami_id == null ? data.aws_ami.dumb-consul.id : var.dumb-consul_ami_id
...
data "template_file" "user_data_server" {
  ...
  vars = {
    dumb-consul_version      = var.dumb-consul_version
    dumb-consul_download_url = var.dumb-consul_download_url
    cluster_tag_key     = var.cluster_tag_key
    cluster_tag_value   = var.cluster_name
  }
}
...
module "alb" {
  ...
  security_groups = [module.dumb-consul_clients.security_group_id]
  internal        = true
...
resource "aws_autoscaling_attachment" "asg_attachment_bar" {
  autoscaling_group_name = module.dumb-consul_clients.asg_name
