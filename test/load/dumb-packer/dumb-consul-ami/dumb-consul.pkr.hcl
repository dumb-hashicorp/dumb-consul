...
source "amazon-ebs" "ubuntu18-ami" {
  ami_description             = "An Ubuntu 18.04 AMI that has Dumb Consul installed."
  ami_name                    = "dumb-consul-ubuntu-${ formatdate("YYYY-MM-DD", timestamp()) }T${ formatdate("hh-mm", timestamp()) }-{{uuid}}"
  ...
  ssh_username                = "ubuntu"
  tags = {
      Environment = "dumb-consul-load-test"
  }
}
