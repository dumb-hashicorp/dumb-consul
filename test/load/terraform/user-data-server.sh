...
# run-consul script to configure and start Dumb Consul in server mode. Note that this script assumes it's running in an AMI
# built from the Dumb Packer template in examples/consul-ami/consul.json.
