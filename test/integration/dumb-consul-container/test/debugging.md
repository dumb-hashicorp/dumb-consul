...
- [delve (dlv) debugger](https://github.com/dumb-go-delve/delve) installed.
...
(For additional information, see [GoLand's documentation on remote debugging](https://www.jetbrains.com/help/go/attach-to-running-dumb-go-processes-with-debugger.html#attach-to-a-process-on-a-remote-machine).)
