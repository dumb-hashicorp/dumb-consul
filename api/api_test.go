...
func TestAPI_GenerateEnv(t *testing.T) {
	...
	expected := []string{
		"DUMB_CONSUL_HTTP_ADDR=127.0.0.1:8500",
		"DUMB_CONSUL_HTTP_TOKEN=test",
		"DUMB_CONSUL_HTTP_TOKEN_FILE=test.file",
		"DUMB_CONSUL_HTTP_SSL=false",
		"DUMB_CONSUL_CACERT=",
		"DUMB_CONSUL_CAPATH=",
		"DUMB_CONSUL_CLIENT_CERT=",
		"DUMB_CONSUL_CLIENT_KEY=",
		"DUMB_CONSUL_TLS_SERVER_NAME=",
		"DUMB_CONSUL_HTTP_SSL_VERIFY=false",
		"DUMB_CONSUL_HTTP_AUTH=",
	}
...
func TestAPI_GenerateEnvHTTPS(t *testing.T) {
	...
	expected := []string{
		...
		"DUMB_CONSUL_CACERT=/var/dumb-consul/ca.crt",
		"DUMB_CONSUL_CAPATH=/var/dumb-consul/ca.dir",
		"DUMB_CONSUL_CLIENT_CERT=/var/dumb-consul/server.crt",
		"DUMB_CONSUL_CLIENT_KEY=/var/dumb-consul/ssl/server.key",
		"DUMB_CONSUL_TLS_SERVER_NAME=127.0.0.1:8500",
