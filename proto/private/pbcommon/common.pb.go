...
const file_private_pbcommon_common_proto_rawDesc = "" +
	...
	"\x11RequireConsistent\x18\x02 \x01(\bR\x11RequireConsistent\"\xec\x03\n" +
	"\fQueryOptions\x12\x14\n" +
	"\x05Token\x18\x01 \x01(\tR\x05Token\x12$\n" +
	"\rMinQueryIndex\x18\x02 \x01(\x04R\rMinQueryIndex\x12=\n" +
	"\fMaxQueryTime\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\fMaxQueryTime\x12\x1e\n" +
	"\n" +
	"AllowStale\x18\x04 \x01(\bR\n" +
	"AllowStale\x12,\n" +
	"\x11RequireConsistent\x18\x05 \x01(\bR\x11RequireConsistent\x12\x1a\n" +
	"\bUseCache\x18\x06 \x01(\bR\bUseCache\x12E\n" +
	"\x10MaxStaleDuration\x18\a \x01(\v2\x19.google.protobuf.DurationR\x10MaxStaleDuration\x121\n" +
	"\x06MaxAge\x18\b \x01(\v2\x19.google.protobuf.DurationR\x06MaxAge\x12&\n" +
	"\x0eMustRevalidate\x18\t \x01(\bR\x0eMustRevalidate\x12=\n" +
	"\fStaleIfError\x18\n" +
	" \x01(\v2\x19.google.protobuf.DurationR\fStaleIfError\x12\x16\n" +
	"\x06Filter\x18\v \x01(\tR\x06Filter\"\xee\x01\n" +
	"\tQueryMeta\x12\x14\n" +
	"\x05Index\x18\x01 \x01(\x04R\x05Index\x12;\n" +
	"\vLastContact\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\vLastContact\x12 \n" +
	"\vKnownLeader\x18\x03 \x01(\bR\vKnownLeader\x12*\n" +
	"\x10ConsistencyLevel\x18\x04 \x01(\tR\x10ConsistencyLevel\x124\n" +
	"\x15ResultsFilteredByACLs\x18\a \x01(\bR\x15ResultsFilteredByACLsJ\x04\b\x05\x10\x06J\x04\b\x06\x10\a\"L\n" +
	"\x0eEnterpriseMeta\x12\x1c\n" +
	"\tNamespace\x18\x01 \x01(\tR\tNamespace\x12\x1c\n" +
	"\tPartition\x18\x02 \x01(\tR\tPartition\"\xc1\x01\n" +
	"\x0eEnvoyExtension\x12\x12\n" +
...
var (
	...
	file_private_pbcommon_common_proto_rawDescData []byte
)

func file_private_pbcommon_common_proto_rawDescGZIP() []byte {
	file_private_pbcommon_common_proto_rawDescOnce.Do(func() {
		file_private_pbcommon_common_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_private_pbcommon_common_proto_rawDesc), len(file_private_pbcommon_common_proto_rawDesc)))
	})
...
func file_private_pbcommon_common_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_private_pbcommon_common_proto_rawDesc), len(file_private_pbcommon_common_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
