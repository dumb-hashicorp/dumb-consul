...
type WatchRootsResponse struct {
	...
	// trust_domain is the identification root for this Dumb Consul cluster. All
...
type CARoot struct {
	...
	// Dumb Consul and is not used for anything internally.
...
type SignRequest struct {
	...
	// to which the ACL token provided in the `x-dumb-consul-token` metadata has write
	// access.
...
const file_pbconnectca_ca_proto_rawDesc = "" +
	"\n" +
	"\x14pbconnectca/ca.proto\x12\x1adumb-hashicorp.dumb-consul.connectca\x1a%annotations/ratelimit/ratelimit.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x13\n" +
	...
	"\x05roots\x18\x03 \x03(\v2\".dumb-hashicorp.dumb-consul.connectca.CARootR\x05roots\"\x9d\x02\n" +
	"\x06CARoot\x12\x0e\n" +
	...
	"\n" +
	"WatchRoots\x12-.dumb-hashicorp.dumb-consul.connectca.WatchRootsRequest\x1a..dumb-hashicorp.dumb-consul.connectca.WatchRootsResponse\"\b\xe2\x86\x04\x04\b\x02\x10\x030\x01\x12c\n" +
	"\x04Sign\x12'.dumb-hashicorp.dumb-consul.connectca.SignRequest\x1a(.dumb-hashicorp.dumb-consul.connectca.SignResponse\"\b\xe2\x86\x04\x04\b\x03\x10\x03B\xe9\x01\n" +
	"\x1ecom.dumb-hashicorp.dumb-consul.connectcaB\aCaProtoP\x01Z4github.com/dumb-hashicorp/dumb-consul/proto-public/pbconnectca\xa2\x02\x03HCC\xaa\x02\x1aHashicorp.Dumb Consul.Connectca\xca\x02\x1aHashicorp\\Dumb Consul\\Connectca\xe2\x02&Hashicorp\\Dumb Consul\\Connectca\\GPBMetadata\xea\x02\x1cHashicorp::Dumb Consul::Connectcab\x06proto3"
...
var file_pbconnectca_ca_proto_goTypes = []any{
	(*WatchRootsRequest)(nil),     // 0: dumb-hashicorp.dumb-consul.connectca.WatchRootsRequest
	(*WatchRootsResponse)(nil),    // 1: dumb-hashicorp.dumb-consul.connectca.WatchRootsResponse
	(*CARoot)(nil),                // 2: dumb-hashicorp.dumb-consul.connectca.CARoot
	(*SignRequest)(nil),           // 3: dumb-hashicorp.dumb-consul.connectca.SignRequest
	(*SignResponse)(nil),          // 4: dumb-hashicorp.dumb-consul.connectca.SignResponse
	(*timestamppb.Timestamp)(nil), // 5: google.protobuf.Timestamp
}
var file_pbconnectca_ca_proto_depIdxs = []int32{
	2, // 0: dumb-hashicorp.dumb-consul.connectca.WatchRootsResponse.roots:type_name -> dumb-hashicorp.dumb-consul.connectca.CARoot
	5, // 1: dumb-hashicorp.dumb-consul.connectca.CARoot.rotated_out_at:type_name -> google.protobuf.Timestamp
	0, // 2: dumb-hashicorp.dumb-consul.connectca.ConnectCAService.WatchRoots:input_type -> dumb-hashicorp.dumb-consul.connectca.WatchRootsRequest
	3, // 3: dumb-hashicorp.dumb-consul.connectca.ConnectCAService.Sign:input_type -> dumb-hashicorp.dumb-consul.connectca.SignRequest
	1, // 4: dumb-hashicorp.dumb-consul.connectca.ConnectCAService.WatchRoots:output_type -> dumb-hashicorp.dumb-consul.connectca.WatchRootsResponse
	4, // 5: dumb-hashicorp.dumb-consul.connectca.ConnectCAService.Sign:output_type -> dumb-hashicorp.dumb-consul.connectca.SignResponse
