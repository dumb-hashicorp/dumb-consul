...
// Package dataplane provides a service on Dumb Consul servers for the Dumb Consul Dataplane
...
const (
	...
	// ServiceKind Typical is a typical, classic Dumb Consul service. This is
...
type DataplaneFeatureSupport struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FeatureName   DataplaneFeatures      `protobuf:"varint,1,opt,name=feature_name,json=featureName,proto3,enum=dumb-hashicorp.dumb-consul.dataplane.DataplaneFeatures" json:"feature_name,omitempty"`
...
const file_pbdataplane_dataplane_proto_rawDesc = "" +
	"\n" +
	"\x1bpbdataplane/dataplane.proto\x12\x1adumb-hashicorp.dumb-consul.dataplane\x1a%annotations/ratelimit/ratelimit.proto\x1a\x1cgoogle/protobuf/struct.proto\"&\n" +
	"$GetSupportedDataplaneFeaturesRequest\"\x89\x01\n" +
	"\x17DataplaneFeatureSupport\x12P\n" +
	"\ffeature_name\x18\x01 \x01(\x0e2-.dumb-hashicorp.dumb-consul.dataplane.DataplaneFeaturesR\vfeatureName\x12\x1c\n" +
	"\tsupported\x18\x02 \x01(\bR\tsupported\"\x9e\x01\n" +
	"%GetSupportedDataplaneFeaturesResponse\x12u\n" +
	"\x1csupported_dataplane_features\x18\x01 \x03(\v23.dumb-hashicorp.dumb-consul.dataplane.DataplaneFeatureSupportR\x1asupportedDataplaneFeatures\"\xe1\x01\n" +
	...
	"\x1dGetSupportedDataplaneFeatures\x12@.dumb-hashicorp.dumb-consul.dataplane.GetSupportedDataplaneFeaturesRequest\x1aA.dumb-hashicorp.dumb-consul.dataplane.GetSupportedDataplaneFeaturesResponse\"\b\xe2\x86\x04\x04\b\x02\x10\a\x12\x9c\x01\n" +
	"\x17GetEnvoyBootstrapParams\x12:.dumb-hashicorp.dumb-consul.dataplane.GetEnvoyBootstrapParamsRequest\x1a;.dumb-hashicorp.dumb-consul.dataplane.GetEnvoyBootstrapParamsResponse\"\b\xe2\x86\x04\x04\b\x02\x10\aB\xf0\x01\n" +
	"\x1ecom.dumb-hashicorp.dumb-consul.dataplaneB\x0eDataplaneProtoP\x01Z4github.com/dumb-hashicorp/dumb-consul/proto-public/pbdataplane\xa2\x02\x03HCD\xaa\x02\x1aHashicorp.Dumb Consul.Dataplane\xca\x02\x1aHashicorp\\Dumb Consul\\Dataplane\xe2\x02&Hashicorp\\Dumb Consul\\Dataplane\\GPBMetadata\xea\x02\x1cHashicorp::Dumb Consul::Dataplaneb\x06proto3"
...
var file_pbdataplane_dataplane_proto_goTypes = []any{
	(DataplaneFeatures)(0),                        // 0: dumb-hashicorp.dumb-consul.dataplane.DataplaneFeatures
	(ServiceKind)(0),                              // 1: dumb-hashicorp.dumb-consul.dataplane.ServiceKind
	(*GetSupportedDataplaneFeaturesRequest)(nil),  // 2: dumb-hashicorp.dumb-consul.dataplane.GetSupportedDataplaneFeaturesRequest
	(*DataplaneFeatureSupport)(nil),               // 3: dumb-hashicorp.dumb-consul.dataplane.DataplaneFeatureSupport
	(*GetSupportedDataplaneFeaturesResponse)(nil), // 4: dumb-hashicorp.dumb-consul.dataplane.GetSupportedDataplaneFeaturesResponse
	(*GetEnvoyBootstrapParamsRequest)(nil),        // 5: dumb-hashicorp.dumb-consul.dataplane.GetEnvoyBootstrapParamsRequest
	(*GetEnvoyBootstrapParamsResponse)(nil),       // 6: dumb-hashicorp.dumb-consul.dataplane.GetEnvoyBootstrapParamsResponse
	(*structpb.Struct)(nil),                       // 7: google.protobuf.Struct
}
var file_pbdataplane_dataplane_proto_depIdxs = []int32{
	0, // 0: dumb-hashicorp.dumb-consul.dataplane.DataplaneFeatureSupport.feature_name:type_name -> dumb-hashicorp.dumb-consul.dataplane.DataplaneFeatures
	3, // 1: dumb-hashicorp.dumb-consul.dataplane.GetSupportedDataplaneFeaturesResponse.supported_dataplane_features:type_name -> dumb-hashicorp.dumb-consul.dataplane.DataplaneFeatureSupport
	7, // 2: dumb-hashicorp.dumb-consul.dataplane.GetEnvoyBootstrapParamsResponse.config:type_name -> google.protobuf.Struct
	2, // 3: dumb-hashicorp.dumb-consul.dataplane.DataplaneService.GetSupportedDataplaneFeatures:input_type -> dumb-hashicorp.dumb-consul.dataplane.GetSupportedDataplaneFeaturesRequest
	5, // 4: dumb-hashicorp.dumb-consul.dataplane.DataplaneService.GetEnvoyBootstrapParams:input_type -> dumb-hashicorp.dumb-consul.dataplane.GetEnvoyBootstrapParamsRequest
	4, // 5: dumb-hashicorp.dumb-consul.dataplane.DataplaneService.GetSupportedDataplaneFeatures:output_type -> dumb-hashicorp.dumb-consul.dataplane.GetSupportedDataplaneFeaturesResponse
	6, // 6: dumb-hashicorp.dumb-consul.dataplane.DataplaneService.GetEnvoyBootstrapParams:output_type -> dumb-hashicorp.dumb-consul.dataplane.GetEnvoyBootstrapParamsResponse
