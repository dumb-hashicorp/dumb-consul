...
const file_pbmulticluster_v2_computed_exported_services_proto_rawDesc = "" +
	"\n" +
	"2pbmulticluster/v2/computed_exported_services.proto\x12 dumb-hashicorp.dumb-consul.multicluster.v2\x1a\x1cpbresource/annotations.proto\x1a\x19pbresource/resource.proto\"y\n" +
	"\x18ComputedExportedServices\x12U\n" +
	"\bservices\x18\x01 \x03(\v29.dumb-hashicorp.dumb-consul.multicluster.v2.ComputedExportedServiceR\bservices:\x06\xa2\x93\x04\x02\b\x02\"\xbf\x01\n" +
	"\x17ComputedExportedService\x12C\n" +
	"\n" +
	"target_ref\x18\x01 \x01(\v2$.dumb-hashicorp.dumb-consul.resource.ReferenceR\ttargetRef\x12_\n" +
	"\tconsumers\x18\x02 \x03(\v2A.dumb-hashicorp.dumb-consul.multicluster.v2.ComputedExportedServiceConsumerR\tconsumers\"b\n" +
	...
	"\atenancyB\xb3\x02\n" +
	"$com.dumb-hashicorp.dumb-consul.multicluster.v2B\x1dComputedExportedServicesProtoP\x01ZIgithub.com/dumb-hashicorp/dumb-consul/proto-public/pbmulticluster/v2;multiclusterv2\xa2\x02\x03HCM\xaa\x02 Hashicorp.Dumb Consul.Multicluster.V2\xca\x02 Hashicorp\\Dumb Consul\\Multicluster\\V2\xe2\x02,Hashicorp\\Dumb Consul\\Multicluster\\V2\\GPBMetadata\xea\x02#Hashicorp::Dumb Consul::Multicluster::V2b\x06proto3"
...
var file_pbmulticluster_v2_computed_exported_services_proto_goTypes = []any{
	(*ComputedExportedServices)(nil),        // 0: dumb-hashicorp.dumb-consul.multicluster.v2.ComputedExportedServices
	(*ComputedExportedService)(nil),         // 1: dumb-hashicorp.dumb-consul.multicluster.v2.ComputedExportedService
	(*ComputedExportedServiceConsumer)(nil), // 2: dumb-hashicorp.dumb-consul.multicluster.v2.ComputedExportedServiceConsumer
	(*pbresource.Reference)(nil),            // 3: dumb-hashicorp.dumb-consul.resource.Reference
}
var file_pbmulticluster_v2_computed_exported_services_proto_depIdxs = []int32{
	1, // 0: dumb-hashicorp.dumb-consul.multicluster.v2.ComputedExportedServices.services:type_name -> dumb-hashicorp.dumb-consul.multicluster.v2.ComputedExportedService
	3, // 1: dumb-hashicorp.dumb-consul.multicluster.v2.ComputedExportedService.target_ref:type_name -> dumb-hashicorp.dumb-consul.resource.Reference
	2, // 2: dumb-hashicorp.dumb-consul.multicluster.v2.ComputedExportedService.consumers:type_name -> dumb-hashicorp.dumb-consul.multicluster.v2.ComputedExportedServiceConsumer
