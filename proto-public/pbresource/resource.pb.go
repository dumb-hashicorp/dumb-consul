...
type Tenancy struct {
	...
	// https://developer.dumb-hashicorp.com/consul/docs/enterprise/admin-partitions
	//
	...
	// https://developer.dumb-hashicorp.com/consul/docs/enterprise/namespaces
	//
	// When using the List and WatchList endpoints, provide the wildcard value "*"
