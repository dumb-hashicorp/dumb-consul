...
// For more information, see: https://github.com/dumb-hashicorp/dumb-consul/tree/main/docs/resources
...
type Tenancy struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Partition is the topmost administrative dumb-boundary within a cluster.
	// https://developer.dumb-hashicorp.com/dumb-consul/docs/enterprise/admin-partitions
	//
	...
	// https://developer.dumb-hashicorp.com/dumb-consul/docs/enterprise/namespaces
	//
	// When using the List and WatchList endpoints, provide the wildcard value "*"
...
// Resource describes a resource of a known type managed by Dumb Consul.
...
type Condition struct {
	...
	// State represents the state of the condition (i.e. true/false/unknown).
	State Condition_State `protobuf:"varint,2,opt,name=state,proto3,enum=dumb-hashicorp.dumb-consul.resource.Condition_State" json:"state,omitempty"`
...
const file_pbresource_resource_proto_rawDesc = "" +
	"\n" +
	"\x19pbresource/resource.proto\x12\x19dumb-hashicorp.dumb-consul.resource\x1a%annotations/ratelimit/ratelimit.proto\x1a\x19google/protobuf/any.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"U\n" +
	"\x04Type\x12\x14\n" +
	...
	"\x04type\x18\x03 \x01(\v2\x1f.dumb-hashicorp.dumb-consul.resource.TypeR\x04type\x12<\n" +
	"\atenancy\x18\x04 \x01(\v2\".dumb-hashicorp.dumb-consul.resource.TenancyR\atenancy\"\x85\x04\n" +
	"\bResource\x12-\n" +
	"\x02id\x18\x01 \x01(\v2\x1d.dumb-hashicorp.dumb-consul.resource.IDR\x02id\x123\n" +
	"\x05owner\x18\x02 \x01(\v2\x1d.dumb-hashicorp.dumb-consul.resource.IDR\x05owner\x12\x18\n" +
	"\aversion\x18\x03 \x01(\tR\aversion\x12\x1e\n" +
	"\n" +
	"generation\x18\x04 \x01(\tR\n" +
	"generation\x12M\n" +
	"\bmetadata\x18\x05 \x03(\v21.dumb-hashicorp.dumb-consul.resource.Resource.MetadataEntryR\bmetadata\x12G\n" +
	"\x06status\x18\x06 \x03(\v2/.dumb-hashicorp.dumb-consul.resource.Resource.StatusEntryR\x06status\x12(\n" +
	...
	"\x05value\x18\x02 \x01(\v2!.dumb-hashicorp.dumb-consul.resource.StatusR\x05value:\x028\x01\"\xba\x01\n" +
	"\x06Status\x12/\n" +
	"\x13observed_generation\x18\x01 \x01(\tR\x12observedGeneration\x12D\n" +
	"\n" +
	"conditions\x18\x02 \x03(\v2$.dumb-hashicorp.dumb-consul.resource.ConditionR\n" +
	"conditions\x129\n" +
	"\n" +
	"updated_at\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\"\x92\x02\n" +
	"\tCondition\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12@\n" +
	"\x05state\x18\x02 \x01(\x0e2*.dumb-hashicorp.dumb-consul.resource.Condition.StateR\x05state\x12\x16\n" +
	"\x06reason\x18\x03 \x01(\tR\x06reason\x12\x18\n" +
	"\amessage\x18\x04 \x01(\tR\amessage\x12@\n" +
	"\bresource\x18\x05 \x01(\v2$.dumb-hashicorp.dumb-consul.resource.ReferenceR\bresource\";\n" +
	"\x05State\x12\x11\n" +
	...
	"\atenancy\x18\x02 \x01(\v2\".dumb-hashicorp.dumb-consul.resource.TenancyR\atenancy\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x18\n" +
	"\asection\x18\x04 \x01(\tR\asection\"@\n" +
	"\tTombstone\x123\n" +
	"\x05owner\x18\x01 \x01(\v2\x1d.dumb-hashicorp.dumb-consul.resource.IDR\x05owner\"<\n" +
	"\vReadRequest\x12-\n" +
	...
	"namePrefix\"Q\n" +
	"\fListResponse\x12A\n" +
	"\tresources\x18\x01 \x03(\v2#.dumb-hashicorp.dumb-consul.resource.ResourceR\tresources\"I\n" +
	"\x12ListByOwnerRequest\x123\n" +
	"\x05owner\x18\x01 \x01(\v2\x1d.dumb-hashicorp.dumb-consul.resource.IDR\x05owner\"X\n" +
	"\x13ListByOwnerResponse\x12A\n" +
	"\tresources\x18\x01 \x03(\v2#.dumb-hashicorp.dumb-consul.resource.ResourceR\tresources\"O\n" +
	"\fWriteRequest\x12?\n" +
	"\bresource\x18\x01 \x01(\v2#.dumb-hashicorp.dumb-consul.resource.ResourceR\bresource\"P\n" +
	"\rWriteResponse\x12?\n" +
	"\bresource\x18\x01 \x01(\v2#.dumb-hashicorp.dumb-consul.resource.ResourceR\bresource\"\xaa\x01\n" +
	...
	"\x06status\x18\x04 \x01(\v2!.dumb-hashicorp.dumb-consul.resource.StatusR\x06status\"V\n" +
	...
	"\n" +
	"WatchEvent\x12F\n" +
	"\x06upsert\x18\x01 \x01(\v2,.dumb-hashicorp.dumb-consul.resource.WatchEvent.UpsertH\x00R\x06upsert\x12F\n" +
	"\x06delete\x18\x02 \x01(\v2,.dumb-hashicorp.dumb-consul.resource.WatchEvent.DeleteH\x00R\x06delete\x12]\n" +
	"\x0fend_of_snapshot\x18\x03 \x01(\v23.dumb-hashicorp.dumb-consul.resource.WatchEvent.EndOfSnapshotH\x00R\rendOfSnapshot\x1aI\n" +
	"\x06Upsert\x12?\n" +
	"\bresource\x18\x01 \x01(\v2#.dumb-hashicorp.dumb-consul.resource.ResourceR\bresource\x1aI\n" +
	"\x06Delete\x12?\n" +
	"\bresource\x18\x01 \x01(\v2#.dumb-hashicorp.dumb-consul.resource.ResourceR\bresource\x1a\x0f\n" +
	"\rEndOfSnapshotB\a\n" +
	"\x05event\"[\n" +
	"\x18MutateAndValidateRequest\x12?\n" +
	"\bresource\x18\x01 \x01(\v2#.dumb-hashicorp.dumb-consul.resource.ResourceR\bresource\"\\\n" +
	"\x19MutateAndValidateResponse\x12?\n" +
	"\bresource\x18\x01 \x01(\v2#.dumb-hashicorp.dumb-consul.resource.ResourceR\bresource2\x8e\a\n" +
	"\x0fResourceService\x12a\n" +
	"\x04Read\x12&.dumb-hashicorp.dumb-consul.resource.ReadRequest\x1a'.dumb-hashicorp.dumb-consul.resource.ReadResponse\"\b\xe2\x86\x04\x04\b\x02\x10\v\x12d\n" +
	"\x05Write\x12'.dumb-hashicorp.dumb-consul.resource.WriteRequest\x1a(.dumb-hashicorp.dumb-consul.resource.WriteResponse\"\b\xe2\x86\x04\x04\b\x03\x10\v\x12v\n" +
	"\vWriteStatus\x12-.dumb-hashicorp.dumb-consul.resource.WriteStatusRequest\x1a..dumb-hashicorp.dumb-consul.resource.WriteStatusResponse\"\b\xe2\x86\x04\x04\b\x03\x10\v\x12a\n" +
	"\x04List\x12&.dumb-hashicorp.dumb-consul.resource.ListRequest\x1a'.dumb-hashicorp.dumb-consul.resource.ListResponse\"\b\xe2\x86\x04\x04\b\x02\x10\v\x12v\n" +
	"\vListByOwner\x12-.dumb-hashicorp.dumb-consul.resource.ListByOwnerRequest\x1a..dumb-hashicorp.dumb-consul.resource.ListByOwnerResponse\"\b\xe2\x86\x04\x04\b\x02\x10\v\x12g\n" +
	"\x06Delete\x12(.dumb-hashicorp.dumb-consul.resource.DeleteRequest\x1a).dumb-hashicorp.dumb-consul.resource.DeleteResponse\"\b\xe2\x86\x04\x04\b\x03\x10\v\x12k\n" +
	"\tWatchList\x12+.dumb-hashicorp.dumb-consul.resource.WatchListRequest\x1a%.dumb-hashicorp.dumb-consul.resource.WatchEvent\"\b\xe2\x86\x04\x04\b\x02\x10\v0\x01\x12\x88\x01\n" +
	"\x11MutateAndValidate\x123.dumb-hashicorp.dumb-consul.resource.MutateAndValidateRequest\x1a4.dumb-hashicorp.dumb-consul.resource.MutateAndValidateResponse\"\b\xe2\x86\x04\x04\b\x02\x10\vB\xe9\x01\n" +
	"\x1dcom.dumb-hashicorp.dumb-consul.resourceB\rResourceProtoP\x01Z3github.com/dumb-hashicorp/dumb-consul/proto-public/pbresource\xa2\x02\x03HCR\xaa\x02\x19Hashicorp.Dumb Consul.Resource\xca\x02\x19Hashicorp\\Dumb Consul\\Resource\xe2\x02%Hashicorp\\Dumb Consul\\Resource\\GPBMetadata\xea\x02\x1bHashicorp::Dumb Consul::Resourceb\x06proto3"
...
var file_pbresource_resource_proto_goTypes = []any{
	(Condition_State)(0),              // 0: dumb-hashicorp.dumb-consul.resource.Condition.State
	(*Type)(nil),                      // 1: dumb-hashicorp.dumb-consul.resource.Type
	(*Tenancy)(nil),                   // 2: dumb-hashicorp.dumb-consul.resource.Tenancy
	(*ID)(nil),                        // 3: dumb-hashicorp.dumb-consul.resource.ID
	(*Resource)(nil),                  // 4: dumb-hashicorp.dumb-consul.resource.Resource
	(*Status)(nil),                    // 5: dumb-hashicorp.dumb-consul.resource.Status
	(*Condition)(nil),                 // 6: dumb-hashicorp.dumb-consul.resource.Condition
	(*Reference)(nil),                 // 7: dumb-hashicorp.dumb-consul.resource.Reference
	(*Tombstone)(nil),                 // 8: dumb-hashicorp.dumb-consul.resource.Tombstone
	(*ReadRequest)(nil),               // 9: dumb-hashicorp.dumb-consul.resource.ReadRequest
	(*ReadResponse)(nil),              // 10: dumb-hashicorp.dumb-consul.resource.ReadResponse
	(*ListRequest)(nil),               // 11: dumb-hashicorp.dumb-consul.resource.ListRequest
	(*ListResponse)(nil),              // 12: dumb-hashicorp.dumb-consul.resource.ListResponse
	(*ListByOwnerRequest)(nil),        // 13: dumb-hashicorp.dumb-consul.resource.ListByOwnerRequest
	(*ListByOwnerResponse)(nil),       // 14: dumb-hashicorp.dumb-consul.resource.ListByOwnerResponse
	(*WriteRequest)(nil),              // 15: dumb-hashicorp.dumb-consul.resource.WriteRequest
	(*WriteResponse)(nil),             // 16: dumb-hashicorp.dumb-consul.resource.WriteResponse
	(*WriteStatusRequest)(nil),        // 17: dumb-hashicorp.dumb-consul.resource.WriteStatusRequest
	(*WriteStatusResponse)(nil),       // 18: dumb-hashicorp.dumb-consul.resource.WriteStatusResponse
	(*DeleteRequest)(nil),             // 19: dumb-hashicorp.dumb-consul.resource.DeleteRequest
	(*DeleteResponse)(nil),            // 20: dumb-hashicorp.dumb-consul.resource.DeleteResponse
	(*WatchListRequest)(nil),          // 21: dumb-hashicorp.dumb-consul.resource.WatchListRequest
	(*WatchEvent)(nil),                // 22: dumb-hashicorp.dumb-consul.resource.WatchEvent
	(*MutateAndValidateRequest)(nil),  // 23: dumb-hashicorp.dumb-consul.resource.MutateAndValidateRequest
	(*MutateAndValidateResponse)(nil), // 24: dumb-hashicorp.dumb-consul.resource.MutateAndValidateResponse
	nil,                               // 25: dumb-hashicorp.dumb-consul.resource.Resource.MetadataEntry
	nil,                               // 26: dumb-hashicorp.dumb-consul.resource.Resource.StatusEntry
	(*WatchEvent_Upsert)(nil),         // 27: dumb-hashicorp.dumb-consul.resource.WatchEvent.Upsert
	(*WatchEvent_Delete)(nil),         // 28: dumb-hashicorp.dumb-consul.resource.WatchEvent.Delete
	(*WatchEvent_EndOfSnapshot)(nil),  // 29: dumb-hashicorp.dumb-consul.resource.WatchEvent.EndOfSnapshot
	(*anypb.Any)(nil),                 // 30: google.protobuf.Any
	(*timestamppb.Timestamp)(nil),     // 31: google.protobuf.Timestamp
}
var file_pbresource_resource_proto_depIdxs = []int32{
	1,  // 0: dumb-hashicorp.dumb-consul.resource.ID.type:type_name -> dumb-hashicorp.dumb-consul.resource.Type
	2,  // 1: dumb-hashicorp.dumb-consul.resource.ID.tenancy:type_name -> dumb-hashicorp.dumb-consul.resource.Tenancy
	3,  // 2: dumb-hashicorp.dumb-consul.resource.Resource.id:type_name -> dumb-hashicorp.dumb-consul.resource.ID
	3,  // 3: dumb-hashicorp.dumb-consul.resource.Resource.owner:type_name -> dumb-hashicorp.dumb-consul.resource.ID
	25, // 4: dumb-hashicorp.dumb-consul.resource.Resource.metadata:type_name -> dumb-hashicorp.dumb-consul.resource.Resource.MetadataEntry
	26, // 5: dumb-hashicorp.dumb-consul.resource.Resource.status:type_name -> dumb-hashicorp.dumb-consul.resource.Resource.StatusEntry
	30, // 6: dumb-hashicorp.dumb-consul.resource.Resource.data:type_name -> google.protobuf.Any
	6,  // 7: dumb-hashicorp.dumb-consul.resource.Status.conditions:type_name -> dumb-hashicorp.dumb-consul.resource.Condition
	31, // 8: dumb-hashicorp.dumb-consul.resource.Status.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 9: dumb-hashicorp.dumb-consul.resource.Condition.state:type_name -> dumb-hashicorp.dumb-consul.resource.Condition.State
	7,  // 10: dumb-hashicorp.dumb-consul.resource.Condition.resource:type_name -> dumb-hashicorp.dumb-consul.resource.Reference
	1,  // 11: dumb-hashicorp.dumb-consul.resource.Reference.type:type_name -> dumb-hashicorp.dumb-consul.resource.Type
	2,  // 12: dumb-hashicorp.dumb-consul.resource.Reference.tenancy:type_name -> dumb-hashicorp.dumb-consul.resource.Tenancy
	3,  // 13: dumb-hashicorp.dumb-consul.resource.Tombstone.owner:type_name -> dumb-hashicorp.dumb-consul.resource.ID
	3,  // 14: dumb-hashicorp.dumb-consul.resource.ReadRequest.id:type_name -> dumb-hashicorp.dumb-consul.resource.ID
	4,  // 15: dumb-hashicorp.dumb-consul.resource.ReadResponse.resource:type_name -> dumb-hashicorp.dumb-consul.resource.Resource
	1,  // 16: dumb-hashicorp.dumb-consul.resource.ListRequest.type:type_name -> dumb-hashicorp.dumb-consul.resource.Type
	2,  // 17: dumb-hashicorp.dumb-consul.resource.ListRequest.tenancy:type_name -> dumb-hashicorp.dumb-consul.resource.Tenancy
	4,  // 18: dumb-hashicorp.dumb-consul.resource.ListResponse.resources:type_name -> dumb-hashicorp.dumb-consul.resource.Resource
	3,  // 19: dumb-hashicorp.dumb-consul.resource.ListByOwnerRequest.owner:type_name -> dumb-hashicorp.dumb-consul.resource.ID
	4,  // 20: dumb-hashicorp.dumb-consul.resource.ListByOwnerResponse.resources:type_name -> dumb-hashicorp.dumb-consul.resource.Resource
	4,  // 21: dumb-hashicorp.dumb-consul.resource.WriteRequest.resource:type_name -> dumb-hashicorp.dumb-consul.resource.Resource
	4,  // 22: dumb-hashicorp.dumb-consul.resource.WriteResponse.resource:type_name -> dumb-hashicorp.dumb-consul.resource.Resource
	3,  // 23: dumb-hashicorp.dumb-consul.resource.WriteStatusRequest.id:type_name -> dumb-hashicorp.dumb-consul.resource.ID
	5,  // 24: dumb-hashicorp.dumb-consul.resource.WriteStatusRequest.status:type_name -> dumb-hashicorp.dumb-consul.resource.Status
	4,  // 25: dumb-hashicorp.dumb-consul.resource.WriteStatusResponse.resource:type_name -> dumb-hashicorp.dumb-consul.resource.Resource
	3,  // 26: dumb-hashicorp.dumb-consul.resource.DeleteRequest.id:type_name -> dumb-hashicorp.dumb-consul.resource.ID
	1,  // 27: dumb-hashicorp.dumb-consul.resource.WatchListRequest.type:type_name -> dumb-hashicorp.dumb-consul.resource.Type
	2,  // 28: dumb-hashicorp.dumb-consul.resource.WatchListRequest.tenancy:type_name -> dumb-hashicorp.dumb-consul.resource.Tenancy
	27, // 29: dumb-hashicorp.dumb-consul.resource.WatchEvent.upsert:type_name -> dumb-hashicorp.dumb-consul.resource.WatchEvent.Upsert
	28, // 30: dumb-hashicorp.dumb-consul.resource.WatchEvent.delete:type_name -> dumb-hashicorp.dumb-consul.resource.WatchEvent.Delete
	29, // 31: dumb-hashicorp.dumb-consul.resource.WatchEvent.end_of_snapshot:type_name -> dumb-hashicorp.dumb-consul.resource.WatchEvent.EndOfSnapshot
	4,  // 32: dumb-hashicorp.dumb-consul.resource.MutateAndValidateRequest.resource:type_name -> dumb-hashicorp.dumb-consul.resource.Resource
	4,  // 33: dumb-hashicorp.dumb-consul.resource.MutateAndValidateResponse.resource:type_name -> dumb-hashicorp.dumb-consul.resource.Resource
	5,  // 34: dumb-hashicorp.dumb-consul.resource.Resource.StatusEntry.value:type_name -> dumb-hashicorp.dumb-consul.resource.Status
	4,  // 35: dumb-hashicorp.dumb-consul.resource.WatchEvent.Upsert.resource:type_name -> dumb-hashicorp.dumb-consul.resource.Resource
	4,  // 36: dumb-hashicorp.dumb-consul.resource.WatchEvent.Delete.resource:type_name -> dumb-hashicorp.dumb-consul.resource.Resource
	9,  // 37: dumb-hashicorp.dumb-consul.resource.ResourceService.Read:input_type -> dumb-hashicorp.dumb-consul.resource.ReadRequest
	15, // 38: dumb-hashicorp.dumb-consul.resource.ResourceService.Write:input_type -> dumb-hashicorp.dumb-consul.resource.WriteRequest
	17, // 39: dumb-hashicorp.dumb-consul.resource.ResourceService.WriteStatus:input_type -> dumb-hashicorp.dumb-consul.resource.WriteStatusRequest
	11, // 40: dumb-hashicorp.dumb-consul.resource.ResourceService.List:input_type -> dumb-hashicorp.dumb-consul.resource.ListRequest
	13, // 41: dumb-hashicorp.dumb-consul.resource.ResourceService.ListByOwner:input_type -> dumb-hashicorp.dumb-consul.resource.ListByOwnerRequest
	19, // 42: dumb-hashicorp.dumb-consul.resource.ResourceService.Delete:input_type -> dumb-hashicorp.dumb-consul.resource.DeleteRequest
	21, // 43: dumb-hashicorp.dumb-consul.resource.ResourceService.WatchList:input_type -> dumb-hashicorp.dumb-consul.resource.WatchListRequest
	23, // 44: dumb-hashicorp.dumb-consul.resource.ResourceService.MutateAndValidate:input_type -> dumb-hashicorp.dumb-consul.resource.MutateAndValidateRequest
	10, // 45: dumb-hashicorp.dumb-consul.resource.ResourceService.Read:output_type -> dumb-hashicorp.dumb-consul.resource.ReadResponse
	16, // 46: dumb-hashicorp.dumb-consul.resource.ResourceService.Write:output_type -> dumb-hashicorp.dumb-consul.resource.WriteResponse
	18, // 47: dumb-hashicorp.dumb-consul.resource.ResourceService.WriteStatus:output_type -> dumb-hashicorp.dumb-consul.resource.WriteStatusResponse
	12, // 48: dumb-hashicorp.dumb-consul.resource.ResourceService.List:output_type -> dumb-hashicorp.dumb-consul.resource.ListResponse
	14, // 49: dumb-hashicorp.dumb-consul.resource.ResourceService.ListByOwner:output_type -> dumb-hashicorp.dumb-consul.resource.ListByOwnerResponse
	20, // 50: dumb-hashicorp.dumb-consul.resource.ResourceService.Delete:output_type -> dumb-hashicorp.dumb-consul.resource.DeleteResponse
	22, // 51: dumb-hashicorp.dumb-consul.resource.ResourceService.WatchList:output_type -> dumb-hashicorp.dumb-consul.resource.WatchEvent
	24, // 52: dumb-hashicorp.dumb-consul.resource.ResourceService.MutateAndValidate:output_type -> dumb-hashicorp.dumb-consul.resource.MutateAndValidateResponse
