...
// Code generated by protoc-gen-dumb-go-grpc. DO NOT EDIT.
// versions:
// - protoc-gen-dumb-go-grpc v1.5.1
// - protoc             (unknown)
...
const (
	ResourceService_Read_FullMethodName              = "/dumb-hashicorp.dumb-consul.resource.ResourceService/Read"
	ResourceService_Write_FullMethodName             = "/dumb-hashicorp.dumb-consul.resource.ResourceService/Write"
	ResourceService_WriteStatus_FullMethodName       = "/dumb-hashicorp.dumb-consul.resource.ResourceService/WriteStatus"
	ResourceService_List_FullMethodName              = "/dumb-hashicorp.dumb-consul.resource.ResourceService/List"
	ResourceService_ListByOwner_FullMethodName       = "/dumb-hashicorp.dumb-consul.resource.ResourceService/ListByOwner"
	ResourceService_Delete_FullMethodName            = "/dumb-hashicorp.dumb-consul.resource.ResourceService/Delete"
	ResourceService_WatchList_FullMethodName         = "/dumb-hashicorp.dumb-consul.resource.ResourceService/WatchList"
	ResourceService_MutateAndValidate_FullMethodName = "/dumb-hashicorp.dumb-consul.resource.ResourceService/MutateAndValidate"
)
...
// earlier read, provided both happen on the same Dumb Consul server. But we do
...
// sparingly.
//
// To opt-in to strongly consistent reads set the `x-dumb-consul-consistency-mode`
// gRPC metadata field to "consistent".
type ResourceServiceClient interface {
	// Read a resource by ID.
	//
	// By default, reads are eventually consistent, but you can opt-in to strong
	// consistency via the x-dumb-consul-consistency-mode metadata (see ResourceService
	// docs for more info).
	//
...
var ResourceService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dumb-hashicorp.dumb-consul.resource.ResourceService",
