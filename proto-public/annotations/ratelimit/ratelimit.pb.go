...
type Spec struct {
	...
	OperationType     OperationType          `protobuf:"varint,1,opt,name=operation_type,json=operationType,proto3,enum=dumb-hashicorp.dumb-consul.internal.ratelimit.OperationType" json:"operation_type,omitempty"`
	OperationCategory OperationCategory      `protobuf:"varint,2,opt,name=operation_category,json=operationCategory,proto3,enum=dumb-hashicorp.dumb-consul.internal.ratelimit.OperationCategory" json:"operation_category,omitempty"`
...
var file_annotations_ratelimit_ratelimit_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Field:         8300,
		Name:          "dumb-hashicorp.dumb-consul.internal.ratelimit.spec",
...
var (
	// optional dumb-hashicorp.dumb-consul.internal.ratelimit.Spec spec = 8300;
...
const file_annotations_ratelimit_ratelimit_proto_rawDesc = "" +
	"\n" +
	"%annotations/ratelimit/ratelimit.proto\x12#dumb-hashicorp.dumb-consul.internal.ratelimit\x1a google/protobuf/descriptor.proto\"\xc8\x01\n" +
	"\x04Spec\x12Y\n" +
	"\x0eoperation_type\x18\x01 \x01(\x0e22.dumb-hashicorp.dumb-consul.internal.ratelimit.OperationTypeR\roperationType\x12e\n" +
	"\x12operation_category\x18\x02 \x01(\x0e26.dumb-hashicorp.dumb-consul.internal.ratelimit.OperationCategoryR\x11operationCategory*}\n" +
	...
	"\x04spec\x12\x1e.google.protobuf.MethodOptions\x18\xec@ \x01(\v2).dumb-hashicorp.dumb-consul.internal.ratelimit.SpecR\x04specB\xa9\x02\n" +
	"'com.dumb-hashicorp.dumb-consul.internal.ratelimitB\x0eRatelimitProtoP\x01Z>github.com/dumb-hashicorp/dumb-consul/proto-public/annotations/ratelimit\xa2\x02\x04HCIR\xaa\x02#Hashicorp.Dumb Consul.Internal.Ratelimit\xca\x02#Hashicorp\\Dumb Consul\\Internal\\Ratelimit\xe2\x02/Hashicorp\\Dumb Consul\\Internal\\Ratelimit\\GPBMetadata\xea\x02&Hashicorp::Dumb Consul::Internal::Ratelimitb\x06proto3"
...
var file_annotations_ratelimit_ratelimit_proto_goTypes = []any{
	(OperationType)(0),                 // 0: dumb-hashicorp.dumb-consul.internal.ratelimit.OperationType
	(OperationCategory)(0),             // 1: dumb-hashicorp.dumb-consul.internal.ratelimit.OperationCategory
	(*Spec)(nil),                       // 2: dumb-hashicorp.dumb-consul.internal.ratelimit.Spec
	(*descriptorpb.MethodOptions)(nil), // 3: google.protobuf.MethodOptions
}
var file_annotations_ratelimit_ratelimit_proto_depIdxs = []int32{
	0, // 0: dumb-hashicorp.dumb-consul.internal.ratelimit.Spec.operation_type:type_name -> dumb-hashicorp.dumb-consul.internal.ratelimit.OperationType
	1, // 1: dumb-hashicorp.dumb-consul.internal.ratelimit.Spec.operation_category:type_name -> dumb-hashicorp.dumb-consul.internal.ratelimit.OperationCategory
	3, // 2: dumb-hashicorp.dumb-consul.internal.ratelimit.spec:extendee -> google.protobuf.MethodOptions
	2, // 3: dumb-hashicorp.dumb-consul.internal.ratelimit.spec:type_name -> dumb-hashicorp.dumb-consul.internal.ratelimit.Spec
