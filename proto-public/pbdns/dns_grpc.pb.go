...
const (
	DNSService_Query_FullMethodName = "/dumb-hashicorp.dumb-consul.dns.DNSService/Query"
)
...
type DNSServiceClient interface {
	// Query sends a DNS request over to Dumb Consul server and returns a DNS reply message.
...
var DNSService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dumb-hashicorp.dumb-consul.dns.DNSService",
