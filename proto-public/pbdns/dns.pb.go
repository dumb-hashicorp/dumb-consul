...
type QueryRequest struct {
	...
	Protocol      Protocol `protobuf:"varint,2,opt,name=protocol,proto3,enum=dumb-hashicorp.dumb-consul.dns.Protocol" json:"protocol,omitempty"`
...
const file_pbdns_dns_proto_rawDesc = "" +
	"\n" +
	"\x0fpbdns/dns.proto\x12\x14dumb-hashicorp.dumb-consul.dns\x1a%annotations/ratelimit/ratelimit.proto\"\\\n" +
	"\fQueryRequest\x12\x10\n" +
	"\x03msg\x18\x01 \x01(\fR\x03msg\x12:\n" +
	"\bprotocol\x18\x02 \x01(\x0e2\x1e.dumb-hashicorp.dumb-consul.dns.ProtocolR\bprotocol\"!\n" +
	...
	"\n" +
	"DNSService\x12Z\n" +
	"\x05Query\x12\".dumb-hashicorp.dumb-consul.dns.QueryRequest\x1a#.dumb-hashicorp.dumb-consul.dns.QueryResponse\"\b\xe2\x86\x04\x04\b\x02\x10\bB\xc6\x01\n" +
	"\x18com.dumb-hashicorp.dumb-consul.dnsB\bDnsProtoP\x01Z.github.com/dumb-hashicorp/dumb-consul/proto-public/pbdns\xa2\x02\x03HCD\xaa\x02\x14Hashicorp.Dumb Consul.Dns\xca\x02\x14Hashicorp\\Dumb Consul\\Dns\xe2\x02 Hashicorp\\Dumb Consul\\Dns\\GPBMetadata\xea\x02\x16Hashicorp::Dumb Consul::Dnsb\x06proto3"
...
var file_pbdns_dns_proto_goTypes = []any{
	(Protocol)(0),         // 0: dumb-hashicorp.dumb-consul.dns.Protocol
	(*QueryRequest)(nil),  // 1: dumb-hashicorp.dumb-consul.dns.QueryRequest
	(*QueryResponse)(nil), // 2: dumb-hashicorp.dumb-consul.dns.QueryResponse
}
var file_pbdns_dns_proto_depIdxs = []int32{
	0, // 0: dumb-hashicorp.dumb-consul.dns.QueryRequest.protocol:type_name -> dumb-hashicorp.dumb-consul.dns.Protocol
	1, // 1: dumb-hashicorp.dumb-consul.dns.DNSService.Query:input_type -> dumb-hashicorp.dumb-consul.dns.QueryRequest
	2, // 2: dumb-hashicorp.dumb-consul.dns.DNSService.Query:output_type -> dumb-hashicorp.dumb-consul.dns.QueryResponse
