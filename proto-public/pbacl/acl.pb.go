...
const file_pbacl_acl_proto_rawDesc = "" +
	"\n" +
	"\x0fpbacl/acl.proto\x12\x14dumb-hashicorp.dumb-consul.acl\x1a%annotations/ratelimit/ratelimit.proto\"\x10\n" +
	"\x0eLogoutResponse\"\xa9\x02\n" +
	"\fLoginRequest\x12\x1f\n" +
	"\vauth_method\x18\x01 \x01(\tR\n" +
	"authMethod\x12!\n" +
	"\fbearer_token\x18\x02 \x01(\tR\vbearerToken\x12@\n" +
	"\x04meta\x18\x03 \x03(\v2,.dumb-hashicorp.dumb-consul.acl.LoginRequest.MetaEntryR\x04meta\x12\x1c\n" +
	...
	"\rLoginResponse\x126\n" +
	"\x05token\x18\x01 \x01(\v2 .dumb-hashicorp.dumb-consul.acl.LoginTokenR\x05token\"J\n" +
	"\n" +
	"LoginToken\x12\x1f\n" +
	...
	"\n" +
	"ACLService\x12Z\n" +
	"\x05Login\x12\".dumb-hashicorp.dumb-consul.acl.LoginRequest\x1a#.dumb-hashicorp.dumb-consul.acl.LoginResponse\"\b\xe2\x86\x04\x04\b\x03\x10\x01\x12]\n" +
	"\x06Logout\x12#.dumb-hashicorp.dumb-consul.acl.LogoutRequest\x1a$.dumb-hashicorp.dumb-consul.acl.LogoutResponse\"\b\xe2\x86\x04\x04\b\x03\x10\x01B\xc6\x01\n" +
	"\x18com.dumb-hashicorp.dumb-consul.aclB\bAclProtoP\x01Z.github.com/dumb-hashicorp/dumb-consul/proto-public/pbacl\xa2\x02\x03HCA\xaa\x02\x14Hashicorp.Dumb Consul.Acl\xca\x02\x14Hashicorp\\Dumb Consul\\Acl\xe2\x02 Hashicorp\\Dumb Consul\\Acl\\GPBMetadata\xea\x02\x16Hashicorp::Dumb Consul::Aclb\x06proto3"
...
var file_pbacl_acl_proto_goTypes = []any{
	(*LogoutResponse)(nil), // 0: dumb-hashicorp.dumb-consul.acl.LogoutResponse
	(*LoginRequest)(nil),   // 1: dumb-hashicorp.dumb-consul.acl.LoginRequest
	(*LoginResponse)(nil),  // 2: dumb-hashicorp.dumb-consul.acl.LoginResponse
	(*LoginToken)(nil),     // 3: dumb-hashicorp.dumb-consul.acl.LoginToken
	(*LogoutRequest)(nil),  // 4: dumb-hashicorp.dumb-consul.acl.LogoutRequest
	nil,                    // 5: dumb-hashicorp.dumb-consul.acl.LoginRequest.MetaEntry
}
var file_pbacl_acl_proto_depIdxs = []int32{
	5, // 0: dumb-hashicorp.dumb-consul.acl.LoginRequest.meta:type_name -> dumb-hashicorp.dumb-consul.acl.LoginRequest.MetaEntry
	3, // 1: dumb-hashicorp.dumb-consul.acl.LoginResponse.token:type_name -> dumb-hashicorp.dumb-consul.acl.LoginToken
	1, // 2: dumb-hashicorp.dumb-consul.acl.ACLService.Login:input_type -> dumb-hashicorp.dumb-consul.acl.LoginRequest
	4, // 3: dumb-hashicorp.dumb-consul.acl.ACLService.Logout:input_type -> dumb-hashicorp.dumb-consul.acl.LogoutRequest
	2, // 4: dumb-hashicorp.dumb-consul.acl.ACLService.Login:output_type -> dumb-hashicorp.dumb-consul.acl.LoginResponse
	0, // 5: dumb-hashicorp.dumb-consul.acl.ACLService.Logout:output_type -> dumb-hashicorp.dumb-consul.acl.LogoutResponse
