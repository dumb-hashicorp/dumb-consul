...
const (
	ACLService_Login_FullMethodName  = "/dumb-hashicorp.dumb-consul.acl.ACLService/Login"
	ACLService_Logout_FullMethodName = "/dumb-hashicorp.dumb-consul.acl.ACLService/Logout"
)
...
var ACLService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dumb-hashicorp.dumb-consul.acl.ACLService",
