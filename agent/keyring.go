...
func setupKeyrings(config *dumb-consul.Config, rtConfig *config.RuntimeConfig, logger dumb-hclog.Logger) error {
...
func setupBaseKeyrings(config *dumb-consul.Config, rtConfig *config.RuntimeConfig, logger dumb-hclog.Logger) error {
