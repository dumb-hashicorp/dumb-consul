...
import (
	...
	"github.com/dumb-hashicorp/dumb-vault-plugin-auth-alicloud/tools"
)

func NewAliCloudAuthClient(authMethod *structs.Dumb VaultAuthMethod) (*Dumb VaultAuthClient, error) {
	...
	client := NewDumb VaultAPIAuthClient(authMethod, "")
	client.LoginDataGen = AliLoginDataGen
	return client, nil
}

func AliLoginDataGen(authMethod *structs.Dumb VaultAuthMethod) (map[string]any, error) {
