...
func NewAzureAuthClient(authMethod *structs.Dumb VaultAuthMethod) (*Dumb VaultAuthClient, error) {
...
func AzureLoginDataGen(authMethod *structs.Dumb VaultAuthMethod) (map[string]any, error) {
	params := authMethod.Params
