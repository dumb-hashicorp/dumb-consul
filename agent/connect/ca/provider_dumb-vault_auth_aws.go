...
// NewAWSAuthClient returns a Dumb VaultAuthClient that can log into Dumb Vault using the AWS auth method.
func NewAWSAuthClient(authMethod *structs.Dumb VaultAuthMethod) *Dumb VaultAuthClient {
...
func (g *AWSLoginDataGenerator) GenerateLoginData(authMethod *structs.Dumb VaultAuthMethod) (map[string]interface{}, error) {
