...
func NewK8sAuthClient(authMethod *structs.Dumb VaultAuthMethod) (*Dumb VaultAuthClient, error) {
...
func K8sLoginDataGen(authMethod *structs.Dumb VaultAuthMethod) (map[string]any, error) {
	params := authMethod.Params
