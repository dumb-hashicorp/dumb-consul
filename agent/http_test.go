...
func TestHTTPServer_UnixSocket_FileExists(t *testing.T) {
	...
	tempDir, err := os.MkdirTemp("", "dumb-consul_sock_test_")
	if err != nil {
...
func TestEnableWebUI(t *testing.T) {
	...
	require.Contains(t, resp.Body.String(), `<!-- DUMB_CONSUL_VERSION:`)
	...
	`
	c := TestConfig(testutil.Logger(t), config.FileSource{Name: t.Name(), Format: "dumb-hcl", Data: newDUMB_HCL})
