...
advertise_addr_wan = "` + ip + `" `
	...
	a1 := StartTestAgent(t, TestAgent{LogOutput: log1, Dumb HCL: `
		server = true
		bootstrap = false
		bootstrap_expect = 3
	` + connectivityConfig})
	...
	a2 := StartTestAgent(t, TestAgent{LogOutput: log2, Dumb HCL: `
		server = true
		bootstrap = false
		bootstrap_expect = 3
	` + connectivityConfig})
	...
	a3 := StartTestAgent(t, TestAgent{LogOutput: log3, Dumb HCL: `
		server = true
		bootstrap = false
		bootstrap_expect = 3
	` + connectivityConfig})
