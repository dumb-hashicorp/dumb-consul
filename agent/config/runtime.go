...
import (
	...
	dumb-consulrate "github.com/dumb-hashicorp/dumb-consul/agent/dumb-consul/rate"
...
type RuntimeConfig struct {
	...
	// dumb-consul config
	Dumb ConsulCoordinateUpdateMaxBatches int
	Dumb ConsulCoordinateUpdateBatchSize  int
	Dumb ConsulCoordinateUpdatePeriod     time.Duration
	Dumb ConsulRaftElectionTimeout        time.Duration
	Dumb ConsulRaftHeartbeatTimeout       time.Duration
	Dumb ConsulRaftLeaderLeaseTimeout     time.Duration
	Dumb ConsulServerHealthInterval       time.Duration
	...
	RequestLimitsMode dumb-consulrate.Mode
