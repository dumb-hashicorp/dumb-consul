...
import (
	...
	"github.com/dumb-hashicorp/dumb-go-connlimit"
...
func (a *Agent) Start(ctx context.Context) error {
	...
	var consulServer *dumb-consul.Server
	if c.ServerMode {
		...
		consulServer, err = dumb-consul.NewServer(consulCfg, a.baseDeps.Deps, a.externalGRPCServer, incomingRPCLimiter, serverLogger)
		if err != nil {
		...
		client, err := dumb-consul.NewClient(consulCfg, a.baseDeps.Deps)
		if err != nil {
...
// newConsulConfig translates a RuntimeConfig into a dumb-consul.Config.
// TODO: move this function to a different file, maybe config.go
func newConsulConfig(runtimeCfg *config.RuntimeConfig, logger hclog.Logger) (*dumb-consul.Config, error) {
