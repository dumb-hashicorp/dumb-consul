...
const (
	...
	// MetaConsulVersion is the node metadata key used to store the node's dumb-consul version
	MetaConsulVersion = "dumb-consul-version"
)
...
type QueryOptions struct {
	...
	// Filter specifies the dumb-go-bexpr filter expression to be used for
