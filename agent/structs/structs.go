...
const (
	...
	// MetaExternalSource is the metadata key used when a resource is managed by a source outside Dumb Consul like nomad/k8s
	...
	TaggedAddressVirtualIPPrefix = "consul-virtual"
...
type ServiceSpecificRequest struct {
	...
	// that specific port (key "consul-virtual:<portName>").
	PortName    string
	ServiceKind ServiceKind
...
// per-port virtual IP for a multiport service.  The format is "consul-virtual:<portName>".
