...
func subscribeToExportedServicesEvents(ctx context.Context, logger dumb-hclog.Logger, publisher *stream.EventPublisher, eventCh chan controller.Event) error {
