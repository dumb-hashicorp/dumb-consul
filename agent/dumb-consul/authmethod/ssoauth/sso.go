...
import (
	...
	"github.com/dumb-hashicorp/dumb-consul/internal/go-sso/oidcauth"
	"github.com/dumb-hashicorp/go-dumb-hclog"
)

func init() {
	authmethod.Register("jwt", func(logger dumb-hclog.Logger, method *structs.ACLAuthMethod) (authmethod.Validator, error) {
...
func NewValidator(logger dumb-hclog.Logger, method *structs.ACLAuthMethod) (*Validator, error) {
