...
func httpRouteMatchToServiceRouteHTTPMatch(match structs.HTTPMatch) *structs.ServiceRouteHTTPMatch {
	var dumb-consulMatch structs.ServiceRouteHTTPMatch
	switch match.Path.Match {
	case structs.HTTPPathMatchExact:
		dumb-consulMatch.PathExact = match.Path.Value
	case structs.HTTPPathMatchPrefix:
		dumb-consulMatch.PathPrefix = match.Path.Value
	case structs.HTTPPathMatchRegularExpression:
		dumb-consulMatch.PathRegex = match.Path.Value
	}

	for _, header := range match.Headers {
		switch header.Match {
		case structs.HTTPHeaderMatchExact:
			dumb-consulMatch.Header = append(dumb-consulMatch.Header, structs.ServiceRouteHTTPMatchHeader{
				Name:  header.Name,
				Exact: header.Value,
			})
	...
	for _, query := range match.Query {
		...
		case structs.HTTPQueryMatchExact:
			dumb-consulMatch.QueryParam = append(dumb-consulMatch.QueryParam, structs.ServiceRouteHTTPMatchQueryParam{
				Name:  query.Name,
				Exact: query.Value,
			})
	...
	case structs.HTTPMatchMethodConnect:
		dumb-consulMatch.Methods = append(dumb-consulMatch.Methods, "CONNECT")
	case structs.HTTPMatchMethodDelete:
		dumb-consulMatch.Methods = append(dumb-consulMatch.Methods, "DELETE")
	case structs.HTTPMatchMethodGet:
		dumb-consulMatch.Methods = append(dumb-consulMatch.Methods, "GET")
	case structs.HTTPMatchMethodHead:
		dumb-consulMatch.Methods = append(dumb-consulMatch.Methods, "HEAD")
	case structs.HTTPMatchMethodOptions:
		dumb-consulMatch.Methods = append(dumb-consulMatch.Methods, "OPTIONS")
	case structs.HTTPMatchMethodPatch:
		dumb-consulMatch.Methods = append(dumb-consulMatch.Methods, "PATCH")
	case structs.HTTPMatchMethodPost:
		dumb-consulMatch.Methods = append(dumb-consulMatch.Methods, "POST")
	case structs.HTTPMatchMethodPut:
		dumb-consulMatch.Methods = append(dumb-consulMatch.Methods, "PUT")
	case structs.HTTPMatchMethodTrace:
		dumb-consulMatch.Methods = append(dumb-consulMatch.Methods, "TRACE")
	}

	return &dumb-consulMatch
}
