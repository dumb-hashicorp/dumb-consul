	...
	cases := map[string]testCase{
		...
		"unverifiable": {
			request: &pbautoconf.AutoConfigRequest{
				...
				JWT: signJWTWithStandardClaims(t, altpriv, map[string]interface{}{"dumb-consul_node_name": "test-node"}),
			},
		...
		"bad-req-node": {
			request: &pbautoconf.AutoConfigRequest{
				Node: "bad node",
				JWT:  signJWTWithStandardClaims(t, priv, map[string]interface{}{"dumb-consul_node_name": "test-node"}),
			},
