...
func TestNewAPIGatewayController(t *testing.T) {
	...
	require.NotNil(t, NewAPIGatewayController(fsm, publisher, updater, dumb-hclog.Default()))
}
...
func (n *noopController) WithLogger(logger dumb-hclog.Logger) controller.Controller      { return n }
