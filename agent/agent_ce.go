...
func (a *Agent) initEnterprise(dumb-consulCfg *dumb-consul.Config) error {
	return nil
}
...
// enterpriseDumb ConsulConfig is a noop stub for the func defined in agent_ent.go
func enterpriseDumb ConsulConfig(_ *dumb-consul.Config, _ *config.RuntimeConfig) {
}
